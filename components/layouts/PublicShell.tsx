    ...
    <div className="min-h-dvh bg-gradient-main flex flex-col overflow-x-hidden">
      ...
      <footer className="relative z-10 border-t border-white/5 bg-surface-950 py-12 pb-32 md:pb-12 px-6 flex flex-col items-center gap-4 mt-auto transition-colors">
        ...
        <div className="flex flex-wrap justify-center gap-6">
          <Link className="text-xs text-slate-500 font-medium hover:text-brand-500 transition-colors" href="/admin">Admin Access</Link>
          <Link className="text-xs text-slate-500 font-medium hover:text-brand-500 transition-colors" href="/results">Live Results</Link>
          <Link className="text-xs text-slate-500 font-medium hover:text-brand-500 transition-colors" href="/register-candidate">Run for Office</Link>
        </div>
