      ...
      {editCandidate && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60">
          <Card className="w-full max-w-2xl bg-surface-800 border border-glass-border p-8 overflow-y-auto max-h-[90vh]">
            <h3 className="text-xl font-bold text-white mb-6">Edit Candidate Details</h3>
            <form onSubmit={handleEditSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-1">
                  <label className="block text-sm font-medium text-slate-400">Scholar Code</label>
                  <input
                    className="w-full px-4 py-2.5 bg-surface-900 border border-glass-border rounded-xl text-white focus:outline-none focus:ring-1 focus:ring-brand-500"
                ...
                <div className="space-y-1">
                  <label className="block text-sm font-medium text-slate-400">School / Campus</label>
                  <input
                    className="w-full px-4 py-2.5 bg-surface-900 border border-glass-border rounded-xl text-white focus:outline-none focus:ring-1 focus:ring-brand-500"
                ...
                <div className="space-y-1">
                  <label className="block text-sm font-medium text-slate-400">Year of Study</label>
                  <select
              ...
              <div className="space-y-1">
                <label className="block text-sm font-medium text-slate-400">Position Running For</label>
                <select
                  className="w-full px-4 py-2.5 bg-surface-900 border border-glass-border rounded-xl text-white focus:outline-none focus:ring-1 focus:ring-brand-500 appearance-none"
              ...
              <div className="flex justify-end gap-3 pt-4">
                <Button variant="ghost" type="button" onClick={() => setEditCandidate(null)} disabled={isSubmitting}>
                  Cancel
                </Button>
