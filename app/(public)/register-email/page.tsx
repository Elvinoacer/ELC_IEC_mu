...
export const metadata = {
  ...
  description:
    "Link your email address to your voter account to receive OTPs on election day.",
};
    ...
    <PublicShell>
      <div className="mx-auto max-w-lg px-4 py-10 sm:py-16 lg:py-24">
        <div className="mb-8 text-center">
          <div
            className={`inline-flex items-center gap-2 ${isOpen ? "bg-accent-500/10 border-accent-500/20 text-accent-400" : "bg-slate-500/10 border-slate-500/20 text-slate-400"} px-3 py-1 rounded-full border mb-4`}
          >
            <svg
              className="w-4 h-4"
              fill="none"
            ...
            <div className="p-10 rounded-[2.5rem] bg-white/5 border border-white/10 text-center space-y-6">
              <div className="w-16 h-16 bg-slate-500/10 rounded-2xl flex items-center justify-center mx-auto text-slate-500">
                ...
                >
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeWidth={2}
                    d="M12 15v2m-6 4h12a2.25 2.25 0 002.25-2.25v-6a2.25 2.25 0 00-2.25-2.25H6a2.25 2.25 0 00-2.25 2.25v6A2.25 2.25 0 006 21z"
                  />
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    strokeWidth={2}
                    d="M15 7V5a3 3 0 00-6 0v2h6z"
                  />
                </svg>
              </div>
              <div className="space-y-2">
                ...
                <p className="text-sm text-slate-400 leading-relaxed max-w-xs mx-auto">
                  You cannot link your email at this time. Please refer to the
                  official election schedule on the home page.
                </p>
              </div>
