      ...
      <div className="mx-auto max-w-7xl px-2 sm:px-4 py-6 sm:py-10 md:px-6 lg:py-16">
        ...
        {phaseInfo && (
          <div className="flex flex-col items-center mb-16 space-y-6 fade-in">
            <div
              className={`inline-flex items-center gap-3 px-4 py-1.5 rounded-full border ${
                phaseInfo.color === "brand"
                  ? "bg-brand-500/10 border-brand-500/20 text-brand-400"
                  : phaseInfo.color === "accent"
        ...
        {phaseInfo?.phase === "VOTING_CLOSED" ? (
            ...
            <div className="lg:col-span-5 space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-lg text-slate-400 font-medium leading-relaxed">
                  The ELP Moi Chapter voter registry is open. Ensure your
                  eligibility by linking your verified email address today.
                </p>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <Link href="/register-email">
                    <Button
                      variant="outline"
                      className="w-full border-white/10 hover:bg-white/5 text-xs font-bold py-4"
                    >
                      Register to Vote
                    </Button>
                  </Link>
          ...
          <div className="grid grid-cols-1 min-[560px]:grid-cols-2 items-start gap-4 sm:gap-6 lg:grid-cols-12 lg:gap-16">
            ...
            <div className="flex flex-col min-[560px]:col-span-1 lg:col-span-5">
              <div className="mb-5 sm:mb-8 space-y-3 sm:space-y-5">
                <h1 className="text-2xl sm:text-3xl md:text-5xl font-black tracking-tight text-white lg:leading-[1.1]">
                  Vote with <br />
                  <span className="text-transparent bg-clip-text bg-linear-to-r from-brand-400 to-accent-400">
                    Confidence
                  </span>
                </h1>
              ...
              {phaseInfo?.phase === "UPCOMING_VOTING" && (
                <div className="p-8 rounded-3xl bg-white/5 border border-white/10 text-center space-y-4">
                  ...
                  <p className="text-sm text-slate-400">
                    Voting will begin automatically once the countdown reaches
                    zero. Ensure your email is registered in advance.
                  </p>
                  <Link href="/register-email">
                    <Button
                      variant="outline"
            ...
            <div
              id="live-results"
              className="min-[560px]:col-span-1 lg:col-span-7 slide-up"
            >
